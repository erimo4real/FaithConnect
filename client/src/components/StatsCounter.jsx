...
const StatsCounter = () => {
  ...
  const stats = [
    { key: 'members', target: 500, label: 'Members', icon: FaUsers, color: 'text-white/80' },
    { key: 'sermons', target: 1200, label: 'Sermons', icon: FaBible, color: 'text-white/80' },
    { key: 'groups', target: 25, label: 'Small Groups', icon: FaChurch, color: 'text-white/80' },
    { key: 'years', target: 25, label: 'Years of Ministry', icon: FaHeart, color: 'text-white/80' },
  ];
