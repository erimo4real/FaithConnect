  ...
  return (
    <div>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4">
          {loading ? <p className="text-gray-400 text-center py-8">Loading...</p> : filteredItems.length === 0 ? <p className="text-gray-400 text-center py-8">No images found.</p> : (
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-primary mb-4">Follow Us on Social Media</h2>
