        ...
        <section className="section-padding">
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                <h2 className="text-2xl font-bold font-display text-primary mb-6">Submit a Prayer Request</h2>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-secondary focus:border-transparent dark:bg-gray-800 dark:text-gray-100"
                      />
                    </div>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Prayer Type</label>
                            ...
                            <button
                              ...
                              className={`p-2 rounded-lg border-2 text-sm transition-colors flex flex-col items-center gap-1 ${
                                formData.prayerType === type.id
                                  ...
                                  : 'border-gray-200 dark:border-gray-600 hover:border-secondary dark:hover:border-secondary'
                              }`}
                            >
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Prayer Request *</label>
                      <textarea
                        name="request"
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="w-4 h-4"
                        />
                        <label htmlFor="confidential" className="text-gray-700 dark:text-gray-300">
                      ...
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="w-4 h-4"
                        />
                        <label htmlFor="share" className="text-gray-700 dark:text-gray-300">
              ...
              <div>
                <h2 className="text-2xl font-bold font-display text-primary mb-6">Ways to Receive Prayer</h2>
                <div className="space-y-6">
                  <div className="card p-6">
                    <h3 className="text-xl font-bold text-primary mb-2 flex items-center gap-2">
                      <FaChurch className="text-secondary" /> Sunday Service Prayer
                    </h3>
                    <p className="text-gray-600 dark:text-gray-400">Join us at the altar during the closing of each service for prayer ministry.</p>
                  </div>
                  <div className="card p-6">
                    <h3 className="text-xl font-bold text-primary mb-2 flex items-center gap-2">
                      <FaVideo className="text-secondary" /> Online Prayer Meeting
                    </h3>
                    <p className="text-gray-600 dark:text-gray-400">Join our virtual prayer room every Wednesday at 6:30 PM.</p>
                  </div>
                  <div className="card p-6">
                    <h3 className="text-xl font-bold text-primary mb-2 flex items-center gap-2">
                      <FaPhone className="text-secondary" /> Prayer Hotline
                    </h3>
                    <p className="text-gray-600 dark:text-gray-400">Call (555) 123-4567 to speak with a prayer team member.</p>
                  </div>
                  <div className="card p-6">
                    <h3 className="text-xl font-bold text-primary mb-2 flex items-center gap-2">
                      <FaMailBulk className="text-secondary" /> Email Prayer Team
                    </h3>
                    <p className="text-gray-600 dark:text-gray-400">Email prayers@bethelchurch.org for ongoing prayer support.</p>
                  </div>
                </div>
