...
const Contact = () => {
  ...
  return (
    <div>
      <div className="relative h-64 bg-gradient-to-r from-primary to-accent dark:from-[#1e3a8a] dark:to-[#065f46]">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-3 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                      />
                    </div>
                    <div>
                  ...
                  <div className="card p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Bethel Church ilaje Bus Stop Ajah Lagos<br />Lagos State Nigeria</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="card p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">+234 934 720 201</p>
                        <p className="text-gray-500 dark:text-gray-400 text-sm">Mon-Fri: 9AM-5PM</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="card p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">bethelministriesinc01@gmail.com</p>
