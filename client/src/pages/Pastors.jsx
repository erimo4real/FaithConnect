...
const Pastors = () => {
  const leaders = [
    ...
    },
    {
      ...
      bio: "Pastor Sarah leads our women's ministry and young adults programs. She has a heart for discipling the next generation and has been instrumental in growing our young adults congregation.",
      ministry: "Women's Ministry, Young Adults"
    },
    {
      id: 3,
      ...
      bio: "Pastor Michael oversees our young adults ministry. He loves helping young people discover their identity in Christ and has a gift for making biblical teaching relevant to today's young adults.",
      ministry: "Young Adults Ministry, Students"
    },
    {
      id: 4,
      name: "Lisa Martinez",
  ...
  const staff = [
    ...
    { name: "Amanda Garcia", role: "Administrative Secretary", image: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=200&h=200&fit=crop" },
