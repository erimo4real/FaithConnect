              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`px-4 py-2 rounded-full transition-colors ${
                    mediaFilter === 'all' ? 'bg-primary text-white' : 'bg-white text-gray-700 hover:bg-gray-100'
                  }`}
                >
                  All
                </button>
                <button
                  ...
                  className={`px-4 py-2 rounded-full transition-colors flex items-center gap-2 ${
                    mediaFilter === 'audio' ? 'bg-primary text-white' : 'bg-white text-gray-700 hover:bg-gray-100'
                  }`}
                >
                  <FaMicrophone /> Audio
                </button>
                <button
                  ...
                  className={`px-4 py-2 rounded-full transition-colors flex items-center gap-2 ${
                    mediaFilter === 'video' ? 'bg-primary text-white' : 'bg-white text-gray-700 hover:bg-gray-100'
                  }`}
                >
                  <FaVideo /> Video
                </button>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="#" className="bg-gray-800 text-white px-6 py-3 rounded-lg flex items-center gap-2 hover:bg-gray-700 transition-colors">
              <FaMicrophone /> Apple Podcasts
            </a>
            <a href="#" className="bg-primary text-white px-6 py-3 rounded-lg flex items-center gap-2 hover:bg-primary/90 transition-colors">
              Spotify
            </a>
            <a href="#" className="bg-primary text-white px-6 py-3 rounded-lg flex items-center gap-2 hover:bg-primary/90 transition-colors">
